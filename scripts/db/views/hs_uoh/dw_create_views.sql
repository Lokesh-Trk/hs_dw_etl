DROP VIEW IF EXISTS healthscore_dw.uoh_hospital_master_view;
CREATE VIEW healthscore_dw.uoh_hospital_master_view
...
where hospital_cd in ('UOH')
;
 

DROP VIEW IF EXISTS healthscore_dw.uoh_bill_items_master_view;
CREATE VIEW healthscore_dw.uoh_bill_items_master_view
...
join healthscore_dw.uoh_hospital_master_view dh
on dbi.hospital_key = dh.hospital_key
;
  
DROP VIEW IF EXISTS healthscore_dw.uoh_patient_master_view;
CREATE VIEW healthscore_dw.uoh_patient_master_view as
...
DROP VIEW IF EXISTS healthscore_dw.uoh_patient_medications_view;
CREATE VIEW healthscore_dw.uoh_patient_medications_view as
...
join  healthscore_dw.uoh_patient_master_view pm
...
​
DROP VIEW IF EXISTS healthscore_dw.uoh_patient_assessments_view;
CREATE VIEW healthscore_dw.uoh_patient_assessments_view as
...
DROP VIEW IF EXISTS healthscore_dw.uoh_hospital_staff_master_view;
CREATE VIEW healthscore_dw.uoh_hospital_staff_master_view as
...
DROP VIEW IF EXISTS healthscore_dw.uoh_patient_visit_view;
CREATE VIEW healthscore_dw.uoh_patient_visit_view as
...
DROP VIEW IF EXISTS healthscore_dw.uoh_vist_bill_items_view;
CREATE VIEW healthscore_dw.uoh_vist_bill_items_view AS
...
JOIN healthscore_dw.uoh_patient_visit_view pvv ON pvv.patient_visit_key = vbv.patient_visit_key
JOIN healthscore_dw.uoh_bill_items_master_view bim ON fvbi.bill_item_key = bim.bill_item_key
...
DROP VIEW IF EXISTS healthscore_dw.uoh_patient_appt_view;
CREATE VIEW healthscore_dw.uoh_patient_appt_view AS
...
GRANT SELECT ON `healthscore_dw`.`uoh_hospital_master_view` TO 'uoh_db_viewer'@'localhost' ; 
GRANT SELECT ON `healthscore_dw`.`uoh_patient_master_view` TO 'uoh_db_viewer'@'localhost' ; 
GRANT SELECT ON `healthscore_dw`.`uoh_patient_medications_view` TO 'uoh_db_viewer'@'localhost' ; 
GRANT SELECT ON `healthscore_dw`.`uoh_patient_assessments_view` TO 'uoh_db_viewer'@'localhost' ; 
GRANT SELECT ON `healthscore_dw`.`uoh_hospital_staff_master_view` TO 'uoh_db_viewer'@'localhost' ; 
GRANT SELECT ON `healthscore_dw`.`uoh_patient_visit_view` TO 'uoh_db_viewer'@'localhost' ;   
GRANT SELECT ON `healthscore_dw`.`uoh_patient_diagnosis_view` TO 'uoh_db_viewer'@'localhost' ;  
