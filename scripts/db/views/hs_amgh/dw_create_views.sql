DROP VIEW IF EXISTS healthscore_dw.amgh_hospital_master_view;
CREATE VIEW healthscore_dw.amgh_hospital_master_view
...
DROP VIEW IF EXISTS healthscore_dw.amgh_patient_master_view;
CREATE VIEW healthscore_dw.amgh_patient_master_view as
...
DROP VIEW IF EXISTS healthscore_dw.amgh_patient_medications_view;
CREATE VIEW healthscore_dw.amgh_patient_medications_view as
...
join  healthscore_dw.amgh_patient_master_view pm
on fpm.patient_key = pm.patient_key
join healthscore_dw.amgh_hospital_master_view hm
on fpm.prescribed_hospital_key = hm.hospital_key;
​  
DROP VIEW IF EXISTS healthscore_dw.amgh_hospital_staff_master_view;
CREATE VIEW healthscore_dw.amgh_hospital_staff_master_view as
...
DROP VIEW IF EXISTS healthscore_dw.amgh_patient_visit_view;
CREATE VIEW healthscore_dw.amgh_patient_visit_view as
...
effective_from_ts,effective_to_ts,rate_category_nm,dbi.active_flg,consulting_staff_key
 from healthscore_dw.dim_bill_items dbi
join healthscore_dw.amgh_hospital_master_view dh
on dbi.hospital_key = dh.hospital_key
;
​
DROP VIEW IF EXISTS healthscore_dw.amgh_vist_bill_items_view;
CREATE VIEW healthscore_dw.amgh_vist_bill_items_view AS
...
JOIN healthscore_dw.amgh_patient_visit_view pvv ON pvv.patient_visit_key = vbv.patient_visit_key
JOIN healthscore_dw.amgh_bill_items_master_view bim ON fvbi.bill_item_key = bim.bill_item_key
WHERE fvbi.active_flg = 1;
​
DROP view if exists healthscore_dw.amgh_hospital_daily_statistics_view;
CREATE VIEW healthscore_dw.amgh_hospital_daily_statistics_view AS
...
join healthscore_dw.amgh_hospital_master_view hm ON fhds.hospital_key = hm.hospital_key;
​
DROP VIEW IF EXISTS healthscore_dw.amgh_patient_diagnosis_view;
CREATE VIEW healthscore_dw.amgh_patient_diagnosis_view AS
...
DROP VIEW IF EXISTS healthscore_dw.amgh_external_hospital_staff_view;
CREATE VIEW healthscore_dw.amgh_external_hospital_staff_view AS
...
-- CREATE USER amgh_db_viewer@localhost IDENTIFIED BY <PWD>;
GRANT SELECT ON `healthscore_dw`.`amgh_bill_items_master_view` TO 'amgh_db_viewer'@'localhost' ; 
GRANT SELECT ON `healthscore_dw`.`amgh_hospital_master_view` TO 'amgh_db_viewer'@'localhost' ; 
GRANT SELECT ON `healthscore_dw`.`amgh_patient_master_view` TO 'amgh_db_viewer'@'localhost' ; 
GRANT SELECT ON `healthscore_dw`.`amgh_patient_medications_view` TO 'amgh_db_viewer'@'localhost' ;  
GRANT SELECT ON `healthscore_dw`.`amgh_hospital_staff_master_view` TO 'amgh_db_viewer'@'localhost' ; 
GRANT SELECT ON `healthscore_dw`.`amgh_patient_visit_view` TO 'amgh_db_viewer'@'localhost' ; 
GRANT SELECT ON `healthscore_dw`.`amgh_hospital_daily_statistics_view` TO 'amgh_db_viewer'@'localhost' ;  
GRANT SELECT ON `healthscore_dw`.`amgh_patient_diagnosis_view` TO 'amgh_db_viewer'@'localhost' ;  
GRANT SELECT ON `healthscore_dw`.`amgh_vist_bill_items_view` TO 'amgh_db_viewer'@'localhost' ;
grant select on  healthscore_dw.amgh_patient_diagnosis_view to amgh_db_viewer@localhost;
grant select on  healthscore_dw.amgh_external_hospital_staff_view to amgh_db_viewer@localhost; 
